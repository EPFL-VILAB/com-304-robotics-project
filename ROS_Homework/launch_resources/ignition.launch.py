...
ARGUMENTS = [
    ...
    DeclareLaunchArgument("world", default_value="warehouse", description="Ignition World"),
    DeclareLaunchArgument(
        "model", default_value="lite", choices=["standard", "lite"], description="Turtlebot4 Model"
    ),
]
...
def generate_launch_description():
    ...
    # TODO: change the package name `com_project_turtlebot` to be your package name
    pkg_com_project_turtlebot = get_package_share_directory("com_project_turtlebot")

    # Set ignition resource path
    ign_resource_path = SetEnvironmentVariable(
        name="IGN_GAZEBO_RESOURCE_PATH",
        value=[
            os.path.join(pkg_com_project_turtlebot, "models"),
            ":" + os.path.join(pkg_com_project_turtlebot, "worlds"),
    ...
    ld.add_action(LogInfo(msg=[EnvironmentVariable("IGN_GAZEBO_RESOURCE_PATH")])),
    return ld
